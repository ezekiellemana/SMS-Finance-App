...
class ExportManager @Inject constructor(
    ...
    fun exportToExcel(
        ...
        // Write to file
        val fileName = "SMSFinance_${profileName.replace(" ", "_")}_${
    ...
    fun exportToPdf(
        ...
        document.add(Paragraph("SMS Finance Widget", titleFont).apply { spacingAfter = 4f })
        ...
        document.add(table)
        document.add(Paragraph("\n${transactions.size} transactions | Report generated by SMS Finance Widget",
